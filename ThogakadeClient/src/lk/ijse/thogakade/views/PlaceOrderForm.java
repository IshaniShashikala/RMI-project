...
public class PlaceOrderForm extends javax.swing.JFrame implements Observer{
    ...
    private void initComponents() {
        ...
        cancelButton1.setFont(new java.awt.Font("DejaVu Serif", 1, 14)); // NOI18N
        cancelButton1.setText("Print");
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        if (nameText.getText().trim().isEmpty() || descriptionText.getText().trim().isEmpty()
                || unitPriceText.getText().trim().isEmpty() || qtyOnHandText.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter valid data");
            return;
        }

        
        OrderDTO customer = new OrderDTO(
                orderIdText.getText(),
                parseDate(dateText.getText()),
                custIdCombo.getSelectedItem().toString());
        try {
            boolean result = ctrlPlaceOrder.save(customer);
            if (result) {
                loadTable();
                ctrlPlaceOrder.release(orderIdText.getText());
                clearAll();
    ...
    private void cancelButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelButton1ActionPerformed
        try {
            JasperReport compiledReport=(JasperReport) JRLoader.loadObject(PlaceOrderForm.class.getResourceAsStream("/lk/ijse/thogakade/reports/place_order_detail_report.jasper"));
            JasperPrint filledReport = JasperFillManager.fillReport(compiledReport, new HashMap<String,Object>(),new JRTableModelDataSource(itemTable.getModel()));
    ...
    private void itemTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_itemTableMouseClicked
        if (evt.getClickCount() == 2) {
            try {
               OrderDTO resDTO = ctrlPlaceOrder.get(itemTable.getValueAt(itemTable.getSelectedRow(), 0).toString());
                if (ctrlPlaceOrder.reserve(resDTO.getOrderId())) {
                    orderIdText.setText(resDTO.getOrderId());
                    dateText.setText(resDTO.getOrderDate() + "");
                     custIdCombo.setSelectedItem(resDTO.getCustId());
    ...
    private void orderIdTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_orderIdTextActionPerformed
        try {
            ctrlPlaceOrder.reserve(orderIdText.getText());
        } catch (Exception ex) {
            Logger.getLogger(CustomerForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        try {
            ctrlPlaceOrder.unregisterObserver(this);
        } catch (RemoteException ex) {
            Logger.getLogger(PlaceOrderForm.class.getName()).log(Level.SEVERE, null, ex);
        }
